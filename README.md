# Brazilian Portuguese (pt_BR) language pack for Maho ecommerce platform

This repository contains the pt_BR language pack for the Maho e-commerce platform.
It provides localization support for the pt_BR language and region.
...
```bash
composer require mahocommerce/maho-language-pt_br
```
